...
| Entity Name | Entity Description | Column Name | Column Description | Data Type | Primary Key | Not Null | Unique |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Section Locations | The specific location at which the course is taught during scheduled days. The table name of the entity is "SectionLocations". | sectionLocationId | Primary key of a sectionLocation record in the table "SectionTimes". | INTEGER | True | True | True |
...
**Important notes for "prCourseId" and "crCourseId"**:
